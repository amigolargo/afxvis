System.config({
  ...
  map: {
    ...
    "mp3-duration": "npm:mp3-duration@1.0.5",
    "play-audio": "npm:play-audio@0.1.0",
    ...
    "npm:media@0.0.1": {
      "domify": "npm:domify@1.0.0",
      "new-chain": "npm:new-chain@0.0.1"
    },
    "npm:mime@1.3.4": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
    ...
    "npm:mp3-duration@1.0.5": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "suspend": "npm:suspend@0.6.1",
    ...
    "npm:play-audio@0.1.0": {
      "media": "npm:media@0.0.1"
    },
